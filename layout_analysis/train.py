...
parser.add_argument('--num_class', default=2, help='num of classes', type=int)
parser.add_argument('--image_width', default=768, help='image width', type=int)
parser.add_argument('--image_height', default=1024, help='image height', type=int)



def train():
  train_model = model.UnetModel(args.num_class, is_training=True )
